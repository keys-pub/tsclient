...
exports.certPath = exports.appDir = exports.FIDO2Service = exports.RPCService = exports.fido2Service = exports.rpcService = exports.Credentials = void 0;
...
Object.defineProperty(exports, "RPCService", { enumerable: true, get: function () { return rpc_service_1.RPCService; } });
...
const rpcService = (addr, creds) => {
    const packageDefinition = proto_loader_1.createPackageDefinition(rpc_proto_1.default, {
        arrays: true,
        enums: String,
        defaults: true,
    });
    ...
    return new rpc_service_1.RPCService(client);
};
